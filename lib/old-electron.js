  ...
  return fetch(package, { method: 'GET' })
    ...
    .then(json => {
      ...
      if(json.hasOwnProperty('devDependencies')) {
        if(json.devDependencies.hasOwnProperty('electron')) version = json.devDependencies.electron.replace(/^\^/g, '')
      }
      if(json.hasOwnProperty('dependencies')) {
        if(json.dependencies.hasOwnProperty('electron')) version = json.dependencies.electron.replace(/^\^/g, '')
      }
