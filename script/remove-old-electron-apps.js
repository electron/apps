...
console.log(
  `Checking apps ${possibleStart || 0} through ${possibleEnd || 'infinity'} for old electron apps`,
);

async function main() {
  const oldArrays = (await findOldElectronApps(possibleStart, possibleEnd)).filter((old) => {
